...
pub struct R(crate::R<NON_BACKED_GAP_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<NON_BACKED_GAP_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<NON_BACKED_GAP_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<NON_BACKED_GAP_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `non_backed_gap_1` writer"]
pub struct W(crate::W<NON_BACKED_GAP_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<NON_BACKED_GAP_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<NON_BACKED_GAP_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<NON_BACKED_GAP_1_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
