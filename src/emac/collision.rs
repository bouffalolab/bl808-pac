...
pub struct R(crate::R<COLLISION_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<COLLISION_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<COLLISION_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<COLLISION_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `collision` writer"]
pub struct W(crate::W<COLLISION_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<COLLISION_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<COLLISION_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<COLLISION_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
