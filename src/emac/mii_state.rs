...
pub struct R(crate::R<MII_STATE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MII_STATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MII_STATE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MII_STATE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `mii_state` writer"]
pub struct W(crate::W<MII_STATE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MII_STATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MII_STATE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MII_STATE_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
