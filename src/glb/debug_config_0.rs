...
pub struct R(crate::R<DEBUG_CONFIG_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DEBUG_CONFIG_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DEBUG_CONFIG_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DEBUG_CONFIG_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `debug_config_0` writer"]
pub struct W(crate::W<DEBUG_CONFIG_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DEBUG_CONFIG_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DEBUG_CONFIG_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DEBUG_CONFIG_0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
