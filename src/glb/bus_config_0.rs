...
pub struct R(crate::R<BUS_CONFIG_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<BUS_CONFIG_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<BUS_CONFIG_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<BUS_CONFIG_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `bus_config_0` writer"]
pub struct W(crate::W<BUS_CONFIG_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<BUS_CONFIG_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<BUS_CONFIG_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<BUS_CONFIG_0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
