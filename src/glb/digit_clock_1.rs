...
pub struct R(crate::R<DIGIT_CLOCK_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DIGIT_CLOCK_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DIGIT_CLOCK_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DIGIT_CLOCK_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `digit_clock_1` writer"]
pub struct W(crate::W<DIGIT_CLOCK_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DIGIT_CLOCK_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DIGIT_CLOCK_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DIGIT_CLOCK_1_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
