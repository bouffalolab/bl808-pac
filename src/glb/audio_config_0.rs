...
pub struct R(crate::R<AUDIO_CONFIG_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AUDIO_CONFIG_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AUDIO_CONFIG_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AUDIO_CONFIG_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `audio_config_0` writer"]
pub struct W(crate::W<AUDIO_CONFIG_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AUDIO_CONFIG_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AUDIO_CONFIG_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AUDIO_CONFIG_0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
